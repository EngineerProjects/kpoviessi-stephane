...
import { Terminal, Cpu, Database, FolderGit2, Radio, Bot, Languages, Briefcase } from 'lucide-react';
...
const Navigation: React.FC<NavigationProps> = ({ currentView, setView, onAskAI }) => {
  ...
  const navItems = [
    ...
    { id: 'services', label: data.ui.nav.services, icon: <Briefcase size={16} /> }, // Added Services
